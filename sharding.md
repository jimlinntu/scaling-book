...
Note both that we not only achieve about 95% of the peak claimed bandwidth (`4.5e10`) but we also achieve this peak at about 10MB, which when 16-way sharded gives us about 500kB per device (*aside: this is much better than GPUs).
